...
const struct lc_messages __messages_en_us = {
    ...
    .strerror =
        {
                [0] = "Success", [E2BIG] = "Argument list too long",
                ...
                [EBADF] = "Bad file descriptor", [EBADMSG] = "Bad message",
                [EBUSY] = "Device busy", [ECANCELED] = "Operation canceled",
                ...
                [EDQUOT] = "Disc quota exceeded", [EEXIST] = "File exists",
                [EFAULT] = "Bad address", [EFBIG] = "File too large",
                ...
                [EROFS] = "Read-only file system", [ESPIPE] = "Illegal seek",
                [ESRCH] = "No such process", [ESTALE] = "Stale NFS file handle",
                [ETIMEDOUT] = "Operation timed out",
                [ETXTBSY] = "Text file busy", [EXDEV] = "Cross-device link",
        },
